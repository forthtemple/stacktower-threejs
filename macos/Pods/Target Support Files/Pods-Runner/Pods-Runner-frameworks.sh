...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_angle/flutter_angle.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_soloud/flutter_soloud.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FlutterAngle/libEGL.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/FlutterAngle/libGLESv2.framework"
fi
